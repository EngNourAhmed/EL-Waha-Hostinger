...
<a href="#faq" class="mobile-nav-item" onclick="navigateToPage('faq', event)"><span id="m-nav-faq">FAQ</span> <i class="fa-solid fa-arrow-right"></i></a>
    ...
    <script>
        ...
        const arabCountries = [
            { code: 'KW', nameAr: 'الكويت', nameEn: 'Kuwait', dialCode: '+965', flag: '🇰🇼', minLen: 7, maxLen: 12,
              governorates: {
            ...
            { code: 'SA', nameAr: 'السعودية', nameEn: 'Saudi Arabia', dialCode: '+966', flag: '🇸🇦', minLen: 8, maxLen: 12,
              governorates: {
            ...
            { code: 'AE', nameAr: 'الإمارات', nameEn: 'UAE', dialCode: '+971', flag: '🇦🇪', minLen: 8, maxLen: 12,
              governorates: {
                'دبي': ['دبي', 'ديرة', 'بر دبي', 'داون تاون'],
                'أبوظبي': ['أبوظبي', 'العين', 'الظفرة'],
            ...
            { code: 'QA', nameAr: 'قطر', nameEn: 'Qatar', dialCode: '+974', flag: '🇶🇦', minLen: 7, maxLen: 10,
              governorates: {
                'الدوحة': ['الدوحة', 'الدفنة', 'اللؤلؤة'],
                'الريان': ['الريان', 'معيذر'],
                'الوكرة': ['الوكرة'],
                'الخور': ['الخور']
              }
            },
            { code: 'OM', nameAr: 'عُمان', nameEn: 'Oman', dialCode: '+968', flag: '🇴🇲', minLen: 7, maxLen: 10,
              governorates: {
                'مسقط': ['مسقط', 'مطرح', 'بوشر', 'السيب'],
                'ظفار': ['صلالة', 'طاقة'],
                'الباطنة': ['صحار', 'بركاء', 'الرستاق']
              }
            },
            { code: 'BH', nameAr: 'البحرين', nameEn: 'Bahrain', dialCode: '+973', flag: '🇧🇭', minLen: 7, maxLen: 10,
              governorates: {
                'العاصمة': ['المنامة', 'الجفير'],
                'المحرق': ['المحرق', 'البسيتين'],
                'الشمالية': ['البديع', 'سار'],
                'الجنوبية': ['الرفاع', 'مدينة عيسى']
              }
            },
            { code: 'EG', nameAr: 'مصر', nameEn: 'Egypt', dialCode: '+20', flag: '🇪🇬', minLen: 9, maxLen: 12,
              governorates: {
                'القاهرة': ['مدينة نصر', 'مصر الجديدة', 'التجمع الخامس', 'المعادي'],
                'الجيزة': ['الدقي', 'المهندسين', '6 أكتوبر', 'الشيخ زايد'],
                'الإسكندرية': ['سموحة', 'ميامي', 'المنتزه']
              }
            },
            { code: 'JO', nameAr: 'الأردن', nameEn: 'Jordan', dialCode: '+962', flag: '🇯🇴', minLen: 8, maxLen: 11,
              governorates: {
                'عمان': ['عمان', 'عبدون', 'الشميساني'],
                'إربد': ['إربد'],
                'الزرقاء': ['الزرقاء'],
                'العقبة': ['العقبة']
              }
            },
            { code: 'IQ', nameAr: 'العراق', nameEn: 'Iraq', dialCode: '+964', flag: '🇮🇶', minLen: 9, maxLen: 12,
              governorates: {
                'بغداد': ['الكرادة', 'المنصور', 'الزيونة'],
                'البصرة': ['البصرة'],
                'أربيل': ['أربيل']
              }
            },
            { code: 'LB', nameAr: 'لبنان', nameEn: 'Lebanon', dialCode: '+961', flag: '🇱🇧', minLen: 7, maxLen: 10,
              governorates: {
                'بيروت': ['بيروت', 'الحمرا'],
                'جبل لبنان': ['جونية', 'المتن']
              }
            },
            { code: 'SY', nameAr: 'سوريا', nameEn: 'Syria', dialCode: '+963', flag: '🇸🇾', minLen: 8, maxLen: 11,
              governorates: {
                'دمشق': ['دمشق', 'المزة'],
                'حلب': ['حلب']
              }
            },
            { code: 'YE', nameAr: 'اليمن', nameEn: 'Yemen', dialCode: '+967', flag: '🇾🇪', minLen: 8, maxLen: 11,
              governorates: {
                'صنعاء': ['صنعاء', 'حدة'],
                'عدن': ['عدن']
              }
            },
            { code: 'LY', nameAr: 'ليبيا', nameEn: 'Libya', dialCode: '+218', flag: '🇱🇾', minLen: 8, maxLen: 11,
              governorates: {
                'طرابلس': ['طرابلس'],
                'بنغازي': ['بنغازي']
              }
            },
            { code: 'SD', nameAr: 'السودان', nameEn: 'Sudan', dialCode: '+249', flag: '🇸🇩', minLen: 8, maxLen: 11,
              governorates: {
                'الخرطوم': ['الخرطوم', 'أم درمان']
              }
            },
            { code: 'MA', nameAr: 'المغرب', nameEn: 'Morocco', dialCode: '+212', flag: '🇲🇦', minLen: 8, maxLen: 11,
              governorates: {
                'الدار البيضاء': ['الدار البيضاء'],
                'الرباط': ['الرباط']
              }
            },
            { code: 'DZ', nameAr: 'الجزائر', nameEn: 'Algeria', dialCode: '+213', flag: '🇩🇿', minLen: 8, maxLen: 11,
              governorates: {
                'الجزائر العاصمة': ['الجزائر'],
                'وهران': ['وهران']
              }
            },
            { code: 'TN', nameAr: 'تونس', nameEn: 'Tunisia', dialCode: '+216', flag: '🇹🇳', minLen: 7, maxLen: 10,
              governorates: {
                'تونس العاصمة': ['تونس']
              }
            },
            { code: 'PS', nameAr: 'فلسطين', nameEn: 'Palestine', dialCode: '+970', flag: '🇵🇸', minLen: 8, maxLen: 11,
              governorates: {
                'رام الله': ['رام الله'],
                'القدس': ['القدس الشريف']
              }
            },
            { code: 'OTHER', nameAr: 'دولة عربية أخرى', nameEn: 'Other Arab Country', dialCode: '+', flag: '🌍', minLen: 6, maxLen: 15,
              governorates: {
